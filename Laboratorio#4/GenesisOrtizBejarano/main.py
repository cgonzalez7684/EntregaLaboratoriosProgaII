    ...
    try:
        while True: 
            ...
            if (not(tecla.isdigit())):
                ...
                continue
            i = int(tecla)
            #Se crea la primera opción de dividir la cadena y contar las a
            if i == 1:
            ...
            #Se vrea la 2da opción para buscar y reemplazar "es"
            elif i == 2:
            ...
            #Se crea la 3ra opción par convertir la frase a mayúscula              
            elif i==3:
