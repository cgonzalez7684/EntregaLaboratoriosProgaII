def agregar_avion(lista_espera, numero_vuelo):
    ...
    print("Avion agregado a la lista de espera")
...
def mostrar_lista(lista_espera):
    if len(lista_espera) == 0:
        ...
        for i, avion in enumerate(lista_espera, start=1):
            print(f"{i}. Avion {avion}")

def eliminar_avion(lista_espera, numero_vuelo):
    if numero_vuelo in lista_espera:
        lista_espera.remove(numero_vuelo)
        print("Avion eliminado de la lista de espera")
    else:
        print("Avion no encontrado en la lista de espera")
...
while True:
    ...
    if opcion == "1":
        numero_vuelo = input("Digite el número de vuelo del avión: ")
        agregar_avion(lista_espera, numero_vuelo)
    elif opcion == "2":
        mostrar_lista(lista_espera)
    elif opcion == "3":
        numero_vuelo = input("Digite el número de vuelo del avión a eliminar: ")
        eliminar_avion(lista_espera, numero_vuelo)
    elif opcion == "4":
        numero_vuelo = input("Digite el número de vuelo del avión a buscar: ")
        ...
        print("Opción erronea. Por favor, ingrese un número válido.")
